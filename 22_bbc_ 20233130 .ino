...
#define _EMA_ALPHA 0.5    // EMA weight of new sample (ra nge: 0 to 1)
                          // Setting EMA to 1 effectively disables EMA filter.

// Servo adjustment - Set _DUTY_MAX, _NEU, _MIN with your own numbers
#define _DUTY_MAX 3300 // 2000
#define _DUTY_NEU 1650 // 1500
#define _DUTY_MIN 0 // 1000
...
float volt_to_distance(int a_value)
{
  ...
  return 703 + -3.51*a_value + 6.56E-03*a_value*a_value + -4.41E-06*a_value*a_value*a_value;
}
